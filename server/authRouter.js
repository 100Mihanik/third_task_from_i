...
router.get('/users', authMiddleware ,controller.getUsers); //здесь можно сделать управление доступами для админа, пользователя или запрещать использовать этот метод неавторизованным 
